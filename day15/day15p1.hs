...
type IngredientProperty = (Int, Int, Int, Int) -- capacity, durability, flavor, texture
...
parsein str = let (  _, rest0) = substringSplit ": capacity " str
                  ...
                  (tex, _rest) = substringSplit ", calories" rest3
              in (read cap, read dur, read fla, read tex)
...
calc ps as = (\(a,b,c,d) -> if any (<0) [a,b,c,d] then 0 else a*b*c*d) $ foldl1 (\(a,b,c,d) (e,f,g,h) -> (a+e,b+f,c+g,d+h)) $ zipWith (\(a,b,c,d) n -> (n*a, n*b, n*c, n*d)) ps as
